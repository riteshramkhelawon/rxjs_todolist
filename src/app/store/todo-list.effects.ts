...
import { AddItem, ChangeItemState, EditItemNote, Initialize, InitializeSuccess, RemoveItem } from './todo-list.actions';
...
export class TodoListEffects {
  ...
  saveList$ = createEffect(() => this.actions$.pipe(
    ofType(AddItem, ChangeItemState, RemoveItem, EditItemNote),
